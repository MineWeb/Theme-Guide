    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="login-before-two-factor-auth" method="POST" data-ajax="true"
                      action="<?= $this->Html->url(['plugin' => null, 'admin' => false, 'controller' => 'user', 'action' => 'ajax_login']) ?>"
                      data-redirect-url="?">

                    <div class="form-group">
                        <label for="inputEmail3"
                               class="col-sm-2 control-label"><?= $Lang->get('USER__USERNAME') ?></label>
                        <div class="col-sm-10">
                    ...
                    <center><a data-dismiss="modal" href="#" data-toggle="modal"
                               data-target="#lostpasswd"><?= $Lang->get('USER__PASSWORD_FORGOT_LABEL') ?></a></center>
            </div>
            ...
            <form class="form-horizontal" method="POST" data-ajax="true"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default"
                            data-dismiss="modal"><?= $Lang->get('GLOBAL__CLOSE') ?></button>
                    <button type="submit"
                            class="btn btn-primary"><?= $Lang->get('USER__PASSWORD_FORGOT_SEND_MAIL') ?></button>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <?php if ($theme_config['cgu_register'] != ''): ?>
                        <div class="form-group">
                            <div class="checkbox col-sm-12 col-sm-offset-2">
                                <label><input type="checkbox" value="" required>J'ai lu et j'accepte les <a
                                            href="<?= $theme_config['cgu_register'] ?>">conditions d'utilisation</a> du
                                    serveur.</label>
                            </div>
                        </div>
                    <?php endif; ?>
    ...
    <div class="modal modal-medium fade" id="notifications_modal" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" onclick="notification.markAllAsSeen()"
                            data-dismiss="modal"><?= $Lang->get('NOTIFICATIONS__MARK_ALL_AS_SEEN') ?></button>
                    <button type="submit" class="btn btn-danger" onclick="notification.clearAll()"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn disabled"><?= $Lang->get('SHOP__ITEM_TOTAL') ?> : <span
                                id="cart-total-price">0</span> <?= $Configuration->getMoneyName() ?></button>
