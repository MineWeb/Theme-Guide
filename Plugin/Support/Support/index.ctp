...
<div class="container">
  <div class="row">
    <div class="col-md-8">
		  <h1 style="display: inline-block; color:white;"><?= $Lang->get('SUPPORT__SUPPORT') ?></h1>
	...
	<div class="row">
    <div class="col-md-12">
        <a class="btn btn-danger btn-block" href="<?= $this->Html->url(array('plugin' => null, 'admin' => false, 'controller' => 'support', 'action' => 'create')); ?>">
